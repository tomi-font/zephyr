...
#ifndef SECURE_STORAGE_ITS_IMPLEMENTATION_H
#define SECURE_STORAGE_ITS_IMPLEMENTATION_H

#include <psa/storage_common.h>
#include <zephyr/secure_storage/its/caller.h>
...
#endif /* SECURE_STORAGE_ITS_IMPLEMENTATION_H */
